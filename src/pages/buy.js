    ...
    <div className="full-background-image" style={{ backgroundImage: `url(${BuyBg})`}}>
      ...
      <div className="buy-drawer">
        ...
        <div className="buy-logos-group">
          <a href="https://www.nintendo.com/games/detail/hollow-knight-switch"><div className="purchase-logo" style={{ backgroundImage: `url(${Switch})`}}/></a>
          <a href="https://store.playstation.com/en-us/product/UP1822-CUSA13632_00-HOLLOWKNIGHT18US"><div className="purchase-logo" style={{ backgroundImage: `url(${PS4})`}}/></a>
          <a href="https://www.microsoft.com/en-us/p/hollow-knight-voidheart-edition/9mw9469v91lm"><div className="purchase-logo" style={{ backgroundImage: `url(${Xbox})`}}/></a>
          <a href="https://store.steampowered.com/app/367520/Hollow_Knight/"><div className="purchase-logo" style={{ backgroundImage: `url(${Steam})`}}/></a>
          <a href="https://www.gog.com/game/hollow_knight"><div className="purchase-logo" style={{ backgroundImage: `url(${Gog})`}}/></a>
          <a href="https://www.humblebundle.com/store/hollow-knight"><div className="purchase-logo" style={{ backgroundImage: `url(${HumbleStore})`}}/></a>
