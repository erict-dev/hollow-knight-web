    ...
    <div className="section-title-bar bordered-section-title-bar">
      ...
      <div className="friends-logos-container">
        <div className="friends-box">
          ...
          <a href="https://www.fangamer.com/collections/hollow-knight"><div className="friends-button">Browse Cool Merch!</div></a>
        </div>
        ...
        <div className="friends-box">
          ...
          <a href="https://theyetee.com/collections/hollow-knight"><div className="friends-button">Check Out the Range!</div></a>
        </div>
        ...
        <div className="friends-box">
          ...
          <a href="https://ghost-ramp.myshopify.com/collections/videogames"><div className="friends-button">All the Details!</div></a>
        </div>
